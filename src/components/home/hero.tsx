    ...
    <section className="relative isolate overflow-hidden border-b border-white/70">
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-10 px-5 py-10 sm:px-6 lg:grid-cols-[0.88fr_1.12fr] lg:gap-14 lg:px-8 lg:py-18">
        <div className="order-2 text-center lg:order-1 lg:text-left">
          ...
          <h1 className="motion-rise motion-delay-1 font-heading text-primary mt-5 text-4xl leading-[1.08] font-extrabold tracking-[-0.025em] text-balance sm:text-5xl lg:text-[3.6rem]">
            {hero.title}
          </h1>
          ...
          <div className="motion-rise motion-delay-3 mt-7 flex flex-col items-center gap-3 sm:flex-row sm:justify-center lg:justify-start">
            <AnketaTrigger
              ctaSource="hero"
              size="lg"
              className="h-13 w-full rounded-full px-7 text-base shadow-[0_14px_30px_-14px_rgba(126,42,61,0.65)] sm:w-auto"
            >
        ...
        <div className="motion-scale-in relative order-1 mx-auto w-full max-w-2xl sm:max-w-[31rem] lg:order-2 lg:max-w-2xl">
          <div
            className="bg-brand-mint/55 absolute -top-4 -right-3 -z-10 h-[92%] w-[86%] rotate-2 rounded-[46%_54%_41%_59%/54%_43%_57%_46%] sm:-right-6"
            aria-hidden="true"
          />
          <div
            className="shadow-soft bg-brand-mint-soft relative aspect-[4/3] overflow-hidden border-4 border-white/90"
          ...
          >
            ...
            <div
              className="from-primary/10 pointer-events-none absolute inset-0 bg-gradient-to-tr via-transparent to-white/15"
              aria-hidden="true"
            />
          </div>
