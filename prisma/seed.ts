  ...
  await prisma.siteSetting.upsert({
    ...
    create: {
      ...
      data: {
        ...
        audience: [
          {
            ...
            title: "РАС",
            description:
              "Индивидуальный маршрут, ABA-подход, тьютор, сенсорная интеграция, логопед-дефектолог.",
          },
          {
            key: "zprr",
            title: "ЗПРР и ЗРР",
            description:
              "Логопед-дефектолог, логоритмика, игровые занятия, рекомендации родителям.",
          },
          {
            key: "adhd",
            title: "СДВГ",
          ...
          },
          {
            key: "down",
            title: "Синдром Дауна",
            description: "Индивидуальная программа, развитие речи, бытовых и социальных навыков.",
          },
        ],
        ...
        branches: [
          { title: "Главный филиал", address: "г. Бишкек", lat: 42.8303178, lng: 74.5723253 },
        ],
      },
    },
  });
    ...
    const vacancies = [
      {
        ...
        duties:
          "Проведение индивидуальных и групповых занятий; диагностика речевого развития; составление и реализация коррекционных карт.",
        requirements:
          "Профильное образование; опыт работы от 1 года; знание методик; терпение и эмпатия.",
        offer:
          "Дружелюбная команда; профессиональное развитие; гибкий график; конкурентная оплата.",
        sortOrder: 1,
      },
      {
        slug: "psiholog",
